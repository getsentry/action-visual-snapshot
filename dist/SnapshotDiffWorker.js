...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.multiCompareODiff = exports.OVERLAY_COMPOSITE = exports.OVERLAY_OPACITY = void 0;
const sharp_1 = __importDefault(__nccwpck_require__(185));
const fs_1 = __nccwpck_require__(147);
const path_1 = __importDefault(__nccwpck_require__(17));
const getDiffODiff_1 = __nccwpck_require__(524);
exports.OVERLAY_OPACITY = 0.8;
exports.OVERLAY_COMPOSITE = [
    {
        input: Buffer.from([255, 255, 255, Math.round(255 * exports.OVERLAY_OPACITY)]),
        raw: {
            width: 1,
            height: 1,
            channels: 4,
